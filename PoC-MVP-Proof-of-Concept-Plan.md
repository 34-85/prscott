...
Don't build the company to find out if the model works — test the things that would kill it (H1–H4), plus a lightweight test of the upside mechanics (H5):
...
Measured per market by end of pilot (~month 5). Benchmarks anchored to 6AM City economics (CAC <$1, LTV >$25) and the §B graduation logic (~8–12K subs to staff).

| Metric | Target (per market) | Read |
|---|---|---|
| **Subscribers** | **3,000–5,000** | On a trajectory toward the ~8–12K staffing threshold |
| **Subscriber CAC** | **≤ $1.50** | Validates the acquisition model (H1) |
...
## 7. Structure during the MVP (important)

- **No new entity.** Run inside APPA as a program/pilot to avoid premature formation, tax, and overhead.
- **Keep commercial activity contained:** treat early sponsor dollars, discount-card fees, and JV starter-kit sales as **modest, contained pilots / program sponsorship**, so unrelated-business exposure stays minimal during the test. Scaled ad sales, the full discount card, and data integrations move to **APPA Ventures** post-go.
- **Hold the guardrails from day one:** no veterinary/medical advice; factual, sourced editorial; sponsors clearly labeled.
- **Data & consent stewardship from day one:** explicit **panel opt-in**, transparent privacy terms (CCPA-class), and clean separation of consented data — so the §B-Upside data asset is built on a sound, compliant foundation, not retrofitted.
